...
$GLOBALS["used_mime_types"]=array(
	// text
	"text"	=> array($GLOBALS["mimes"]["text"],"filetypes/document-text.png","\.txt$|\.htaccess$"),
	...
	// images
	"gif"	=> array($GLOBALS["mimes"]["gif"],"filetypes/picture_2.png","\.gif$"),
	"jpg"	=> array($GLOBALS["mimes"]["jpg"],"filetypes/picture_2.png","\.jpg$|\.jpeg$"),
	"bmp"	=> array($GLOBALS["mimes"]["bmp"],"filetypes/picture_2.png","\.bmp$"),
	"png"	=> array($GLOBALS["mimes"]["png"],"filetypes/picture_2.png","\.png$"),
	
	//PSD
	"psd"	=> array($GLOBALS["mimes"]["psd"],"filetypes/icon_photoshop.gif","\.psd$"),
