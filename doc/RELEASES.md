...
### Version 2.5.0 BETA - not yet released

#### interface changes:
- there is a new message type 'miscnologin' which should be
  translated to all languages.
- the configuration file has completely changed.
- the .config directory is now named _config
- the .include directory is now named _include
